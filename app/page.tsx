...
const NAV: [string, string][] = [
  ['#show', 'The Show'], ['#burn', 'Burn'], ['#quest', 'The Quest'],
  ['#gallery', 'Gallery'], ['#company', 'Company'], ['#workshops', 'Workshops'], ['/saga', 'The Saga'],
];
    ...
    <>
      ...
      <section id="quest" className="quest">
        <div className="reveal" style={{ position: 'relative', maxWidth: 900, margin: '0 auto' }}>
          ...
          <div className="eyebrow">The Quest</div>
      ...
      <footer className="footer">
        <div className="footer-inner">
          ...
          <div className="footer-social">
            <a href="https://www.instagram.com/mythmaker_official/" target="_blank" rel="noopener" aria-label="Instagram">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><circle cx="12" cy="12" r="4.5"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>
            </a>
            <a href="https://www.facebook.com/mythmakerproductions/" target="_blank" rel="noopener" aria-label="Facebook">
            ...
            <a href="https://www.tiktok.com/@mythmakermagic" target="_blank" rel="noopener" aria-label="TikTok">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.75a4.85 4.85 0 0 1-1.01-.06z"/></svg>
            </a>
            <a href="https://youtube.com/@hjeron" target="_blank" rel="noopener" aria-label="YouTube">
            ...
            <a href="mailto:mythmakerburn@gmail.com" aria-label="Email">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><polyline points="2,4 12,13 22,4"/></svg>
            </a>
          </div>
        </div>
